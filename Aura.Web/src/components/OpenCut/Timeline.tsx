...
const useStyles = makeStyles({
  container: {
    ...
    borderTop: `1px solid ${openCutTokens.colors.border.default}`,
    position: 'relative',
    outline: 'none',
  },
  resizeHandle: {
    ...
    ':hover': {
      backgroundColor: openCutTokens.colors.bg.highlight,
    },
    ':hover::after': {
      backgroundColor: openCutTokens.colors.accent.primary,
      opacity: 1,
    },
    '::after': {
      content: '""',
      width: '48px',
      height: '3px',
      backgroundColor: openCutTokens.colors.border.subtle,
  ...
  zoomControls: {
    ...
    borderRight: `1px solid ${openCutTokens.colors.border.subtle}`,
  },
  undoRedoControls: {
    display: 'flex',
    alignItems: 'center',
  ...
  rulerMarkLabel: {
    ...
    color: openCutTokens.colors.fg.tertiary,
  ...
  trackSelected: {
    backgroundColor: openCutTokens.colors.accent.subtle,
  },
  trackLocked: {
    opacity: 0.6,
  },
  trackLabel: {
    ...
    gap: openCutTokens.spacing.xs,
    padding: 0,
    borderRight: `1px solid ${openCutTokens.colors.border.default}`,
    backgroundColor: openCutTokens.colors.bg.surface,
  },
  trackLabelIcon: {
    color: openCutTokens.colors.fg.tertiary,
  ...
  trackLabelText: {
    ...
    color: openCutTokens.colors.fg.secondary,
  ...
  trackContent: {
    ...
    bottom: 0,
    left: 0,
    backgroundColor: openCutTokens.colors.bg.deep,
  },
  clip: {
    position: 'absolute',
    top: '4px',
